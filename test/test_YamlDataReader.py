...
class TestYamlDataReader:
    ...
    def test_read(self,
                  valid_filepath_and_data:
                  tuple[str, DataType],
                  invalid_filepath_and_data: tuple[str, Any],
                  invalid_data_content: Any, ) -> None:
        ...
        with pytest.raises(Exception):
            yaml_data_reader.init_students_data_from_yaml(
                invalid_filepath_and_data[1]
            )
